...
{
    /// <summary>
    /// Repository for seeding some Stories.
    /// </summary>
    ...
    public class MemoryRepository : BaseRepository, IMannsRepository
    {
        ...
        /// <returns>Bool depending on the deletion success.</returns>
        public async Task<bool> DeleteStory(string postid)
        {
            var story = await this.GetStory(int.Parse(postid));
            if (story != null)
            {
        ...
        public Task<BlogResult> GetStories(int pageSize = 10, int page = 1)
        {
            return Task.FromResult(new BlogResult()
            {
                ...
                TotalPages = this.CalculatePages(Stories.Count(), pageSize),
        ...
        /// <summary>
        /// The stories.
        /// This part can modified and can contain your own blogposts.
        /// </summary>
